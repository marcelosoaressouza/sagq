	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Attachment']))
		{
			$model->attributes=$_POST['Attachment'];
                        ...
                        $dir = 'upload/'.$model->getAttribute('requirement_id').'/';
			...
			$file = CUploadedFile::getInstanceByName('Attachment[file]');
			$file->saveAs('upload/'.$model->getAttribute('requirement_id').'/'.$file->name);
                        $model->setAttribute('file', $file->getName());
